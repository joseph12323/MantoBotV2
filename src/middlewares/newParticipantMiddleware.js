        ...
        case "log:subscribe": // Someone joined the gc
          ...
          for (let newParticipant of addedParticipants1) {
            ...
            if (newParticipant.userFbId == botID1) {
              message1.body = `Hi, I am MantoBot. Thank you for having me as the ${toOrdinalNumber(participants1.length)} member of "${threadName1}".\n\n`;
              ...
              message1.mentions.push({
                tag: "@Danilo Manto", id: "100007515468996"
              });

              // Set bot's nickname
              api.changeNickname("MantoBot", event.threadID, botID1, (err) => {
